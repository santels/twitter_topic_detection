...
cdef class Similarity:
    cdef:
        ...
        np.ndarray[DOUBLE_t, ndim=2] _similarity(self,
            np.ndarray[DOUBLE_t, ndim=2] M1, np.ndarray[DOUBLE_t, ndim=2] M2,
            int is_scoring)

        DOUBLE_t _multiply_elements(self ,np.ndarray[DOUBLE_t, ndim=1] v1,
            np.ndarray[DOUBLE_t, ndim=1] v2)

        DOUBLE_t _soft_cosine_similarity(self, np.ndarray[DOUBLE_t, ndim=1] v1,
            np.ndarray[DOUBLE_t, ndim=1] v2)
